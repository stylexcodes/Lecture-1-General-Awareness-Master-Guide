...
export async function generateAndDownloadPptx(
  ...
  try {
    ...
    const pptxWidth = 8.27; // inches
    const pptxHeight = 11.69; // inches
    ...
    const filename = `GS_By_Durgesh_Pandey_Sir_Master_Notes_${lang.toUpperCase()}_${theme.toUpperCase()}.pptx`;
    await pptx.writeFile({ fileName: filename });

    updateProgress(100, 'Master PPTX successfully downloaded!');
  } finally {
